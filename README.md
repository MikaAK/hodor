...
Hodor is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
Then you can interact with Hodor by typing `Hodor help`.
    ...
    Hodor> animate me <query> - The same thing as `image me`, except adds a few
